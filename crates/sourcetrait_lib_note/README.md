...
License (AGPL3)
--------------------------------------------------------------------------------
SourceTrait Library: Note: Markdown notes manager  
...
[Crate]: https://crates.io/crates/sourcetrait_lib_note
[Crate Badge]: https://img.shields.io/crates/v/sourcetrait_lib_note.svg
[Docs]: https://docs.rs/sourcetrait_lib_note
