...
License (AGPL3)
--------------------------------------------------------------------------------
SourceTrait Library: Box: Sandboxed command-line environments for data analytics scripting    
...
[Crate]: https://crates.io/crates/sourcetrait_lib_box
[Crate Badge]: https://img.shields.io/crates/v/sourcetrait_lib_box.svg
[Docs]: https://docs.rs/sourcetrait_lib_box
